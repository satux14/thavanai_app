...
const translations = {
  en: {
    ...
    signHereByOwner: 'Sign Here (Owner)',
    signedByOwner: 'Signed by Owner',
    signRequestedSign: 'Sign Requested - Click to Sign',
    signedByRequest: 'Signed by Request',
    requestSignature: 'Request Signature',
    signatureRequestPending: 'Request Pending',
    signatureRequestedByBorrower: 'Borrower has requested your signature',
    approve: 'Approve',
    reject: 'Reject',
    pleaseSaveEntryFirst: 'Please save the entry before signing',
    entrySigned: 'Entry signed successfully!',
    signFailed: 'Failed to sign entry',
  ...
  ta: {
    ...
    signHereByOwner: 'இங்கே கையொப்பமிடுங்கள் (உரிமையாளர்)',
    signedByOwner: 'உரிமையாளரால் கையொப்பமிடப்பட்டது',
    signRequestedSign: 'கையொப்பம் கோரப்பட்டது - கிளிக் செய்க',
    signedByRequest: 'கோரிக்கையால் கையொப்பமிடப்பட்டது',
    requestSignature: 'கையொப்பம் கோரவும்',
    signatureRequestPending: 'கோரிக்கை நிலுவையில் உள்ளது',
    signatureRequestedByBorrower: 'கடன் வாங்குபவர் உங்கள் கையொப்பத்தை கோரியுள்ளார்',
    approve: 'ஒப்புக்கொள்',
    reject: 'நிராகரி',
    pleaseSaveEntryFirst: 'கையொப்பமிடும் முன் பதிவை சேமிக்கவும்',
    entrySigned: 'பதிவு வெற்றிகரமாக கையொப்பமிடப்பட்டது!',
    signFailed: 'பதிவில் கையொப்பமிட முடியவில்லை',
